!function (e, t) {
  ...
  var e = {
    ...
    }, l = [], u = {previousWindowKeyDown: null, previousActiveElement: null, previousBodyPadding: null},
    c = function (e) {
      var t = p();
      t && (t.parentNode.removeChild(t), L(document.body, o["no-backdrop"]), L(document.body, o["has-input"]), L(document.body, o["toast-shown"]));
      {
        if ("undefined" != typeof document) {
          ...
          var r = f(), i = T(r, o.input), a = T(r, o.file), l = r.querySelector("." + o.range + " input"),
            u = r.querySelector("." + o.range + " output"), c = T(r, o.select),
            m = r.querySelector("." + o.checkbox + " input"), b = T(r, o.textarea);
  ...
  var I = function (e) {
    ...
    var n = void 0, i = f(), l = "string" == typeof t.target ? document.querySelector(t.target) : t.target;
    ...
    var S = p(), A = b(), B = h(), E = x(), T = w(), O = C(), j = k();
    if (t.titleText ? A.innerText = t.titleText : A.innerHTML = t.title.split("\n").join("<br />"), t.backdrop || P(document.body, o["no-backdrop"]), t.text || t.html) {
      if ("object" === N(t.html)) if (B.innerHTML = "", 0 in t.html) for (var M = 0; M in t.html; M++) B.appendChild(t.html[M].cloneNode(!0)); else B.appendChild(t.html.cloneNode(!0)); else t.html ? B.innerHTML = t.html : t.text && (B.textContent = t.text);
      q(B)
    } else V(B);
    ...
    var R = v(), D = parseInt(null === t.currentProgressStep ? K.getQueueStep() : t.currentProgressStep, 10);
    ...
    return new Promise(function (t, n) {
      ...
      for (var H = function (t) {
        ...
        var n = t || window.event, o = n.target || n.srcElement, r = w(), s = C(),
          u = r && (r === o || r.contains(o)), d = s && (s === o || s.contains(o));
        switch (n.type) {
          case"mouseover":
          case"mouseup":
          ...
          case"mousedown":
            ...
            break;
          case"click":
            if (u && e.isVisible()) if (e.disableButtons(), a.input) {
              var p = function () {
                var e = M();
                if (!e) return null;
                switch (a.input) {
      ...
      var Y = function (e, t) {
        ...
        if ("Enter" === n.key) n.target === M() && (e.clickConfirm(), n.preventDefault()); else if ("Tab" === n.key) {
          for (var o = n.target || n.srcElement, r = S(a.focusCancel), i = -1, s = 0; s < r.length; s++) if (o === r[s]) {
            i = s;
            break
          }
      ...
      for (var $ = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], J = void 0, X = 0; X < $.length; X++) {
        var F = o[$[X]], G = T(m, F);
        if (J = M($[X])) {
          for (var ee in J.attributes) if (J.attributes.hasOwnProperty(ee)) {
      ...
      switch (a.input) {
        ...
        case"file":
          ...
          break;
        case"range":
          var re = T(m, o.range), ie = re.querySelector("input"), ae = re.querySelector("output");
        ...
        case"radio":
          ...
          break;
        case"checkbox":
          var ce = T(m, o.checkbox), de = M("checkbox");
      ...
      "select" !== a.input && "radio" !== a.input || (a.inputOptions instanceof Promise ? (e.showLoading(), a.inputOptions.then(function (t) {
        e.hideLoading(), oe(t)
      })) : "object" === N(a.inputOptions) ? oe(a.inputOptions) : s("Unexpected type of inputOptions! Expected object or Promise, got " + N(a.inputOptions))), function (e, t, n) {
        var r = p(), i = f();
